                        ...
                        <div class="max-w-2xl mx-auto gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                            <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">We’re changing
                                    the way people study.</h1>
                                <p class="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                                    Smarty is a revolutionary app that offers a smarter way to study. It's a digital
                                    note-taking tool that uses artificial intelligence (AI) to help students create
                                    effective study materials. The app is designed to make studying more efficient and
                                    enjoyable for users, by automatically generating flashcards and questions based on
                                    their notes.
                                </p>
                                <div class="flex items-center mt-10 gap-x-6">
                                    <a href="#"
                                        ...
                                        started</a>
                                    <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Live demo
